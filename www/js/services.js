...
//service在使用this指针，而factory直接返回一个对象
  ...
  .service('MainService', function ($q, $http, YuanHenXiang, $ionicHistory, $ionicScrollDelegate) { //首页服务定义
    return {
      ...
      getIndexData: function (params) { //获取首页数据
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Page/index",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (data) {
  ...
  .service('GoodService', function ($q, $http, YuanHenXiang) { //产品商品服务定义
    return {
      ...
      getCollectGoodsList: function (params) { //获取商品收藏列表
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Goods/getCollectGoodsList",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
  ...
  .service('OrderService', function ($q, $http, YuanHenXiang) { //订单相关服务定义
    return {
      addOrder: function (params) { //提交订单
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'POST',
          url: YuanHenXiang.api + "/Order/addOrder",
          data: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      myOrder: function (params) { //我的订单
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Order/myOrder",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      orderInfo: function (params) { //订单详情
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Order/orderInfo",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      cancelOrder: function (params) { //取消订单
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'POST',
          url: YuanHenXiang.api + "/Order/cancelOrder",
          data: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      deleteOrder: function (params) { //删除订单
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'POST',
          url: YuanHenXiang.api + "/Order/deleteOrder",
          data: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      applyRefund: function (params) { //申请退款
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'POST',
          url: YuanHenXiang.api + "/Order/applyRefund",
          data: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
  ...
  .service('AccountService', function ($q, $http, YuanHenXiang, $cordovaFileTransfer, $state, $cordovaToast, $interval, $timeout, $ionicPopup, $ionicLoading, $cordovaFile, $cordovaFileOpener2) {
    return {
      ...
      getIncome: function (params) { //我的收入
        ...
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Account/incomeLog",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      getPointLog: function (params) { //我的积分
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Member/pointLog",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      getMyCoupons: function (params) { //我的优惠券
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Member/myCoupons",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
      ...
      getInviteLog: function (params) { //我的邀请记录
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Member/inviteLog",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
  ...
  .service('CityService', function ($q, $http, YuanHenXiang) { //城市相关的接口
    return {
      setLocation: function (params) { //定位设置
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
      ...
      getAllLetterCity: function (params) { //获取字母关联城市列表
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/City/getAllLetterCity",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
  ...
  .service('SearchService', function ($q, $http, YuanHenXiang) { //搜索相关的接口
    return {
      searchGoods: function (params) { //搜索商品
        var deferred = $q.defer();// 声明延后执行，表示要去监控后面的执行
        var promise = deferred.promise
        promise = $http({
          method: 'GET',
          url: YuanHenXiang.api + "/Search/searchGoods",
          params: params
        }).success(function (data) {
          deferred.resolve(data);// 声明执行成功，即http请求数据成功，可以返回数据了
        }).error(function (err) {
